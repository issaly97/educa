					...
					<?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?> 
                      <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Codecanyon Username" required="" value="NullJungle" name="code_username" type="text">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                            <label for="">Purchase Code*</label>
                            <input class="form-control" placeholder="Purchase Code" name="purchase_code" required="" value="Nulled-By-NullJungle" required type="text">
                        </div>
                      </div>
                  </div>
